...
public class DSLDIParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("DSLDI");
  ...
  { 
    DSLDIParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = DSLDIParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = DSLDIParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(DSLDIParseControllerGenerated.class);
    }
  ...
  { 
    return DSLDIParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
